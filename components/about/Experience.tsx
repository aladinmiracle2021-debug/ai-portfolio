...
export default function Experience() {
  return (
    <section>
      <h3 className=" text-3xl font-semibold mb-12 ">Work Experience</h3>

      <div className=" relative border-l border-cyan-400/30 ml-4 space-y-12 ">
        {experiences.map((item, index) => (
          <div key={index} className=" relative pl-10 ">
            {/* Timeline dot */}

            <div className=" absolute -left-[9px] top-2 w-4 h-4 rounded-full bg-cyan-400 shadow-[0_0_20px_rgba(34,211,238,0.8)] " />
